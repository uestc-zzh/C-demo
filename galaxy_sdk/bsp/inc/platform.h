 ...
 *
 * @file platform.h
 * @brief Common definition for platform
 */
...
#define __ECLIC_BASEADDR (0x0C000000UL)
#else
#define __ECLIC_BASEADDR (0xE0010000UL)
#endif
...
#if CONFIG_QEMU_PLATFORM
#define __SYSTIMER_BASEADDR (0x02000000UL)
#else
#define __SYSTIMER_BASEADDR (0xE0000000UL)
#endif
